# Security — reviewed August 6, 2026
...
- Never scrape authenticated, paywalled, terminal, or subscriber-only premium content; use only contractually authorized API, bulk, SFTP, cloud-delivery, or controlled import methods.
- GitHub Pages publishes only the curated static preview artifact and must never receive backend configuration or secrets.
